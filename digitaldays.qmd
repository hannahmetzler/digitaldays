...
Neu in dem Gebiet: ausgegangen von den üblichen geselschaftlichen Annahmen.
...
Keine Effekte auf Meinungen & gefühlte Spaltung
...
::: notes
Wichtig, nicht zu sagen: algorithmus hat keinen Effekt. Dafür wissen wir viel zu vieles nicht. 
Was wenn es Algorithmen nie gegeben hätte, wenn wir sie für 3 Jahre lang für ein ganzes land abdrehen könnten, wenn ein Land noch nicht polarisiert ist...

Was wir sagen können: Algo nicht so allmächtig wie wir denken. Abdrehen löst unsere Probleme nicht. 

Balancierte Perspektive auf Rolle von Algorithmen. Können menschliche Tendenzen verstärken, lernen aus menschlichen Daten. Wir müssen aber auch auf die sozialen/menschlichen Faktoren achten.
:::
...
::: notes
Wie kann das sein?
6) Welche Soziale Faktoren meine ich da?
...
- Polarisierung der Eliten ([2](https://reutersinstitute.politics.ox.ac.uk/types-sources-and-claims-covid-19-misinformation))
...
- Misinformation von [Oben](https://reutersinstitute.politics.ox.ac.uk/types-sources-and-claims-covid-19-misinformation) hat großen Einfluss
...
::: notes
Bei Polarisierung könnte die soziale Dynamik auf Social Media sehr wohl eine Rolle spielen
...
- Social Media scheint sehr polarisiert, reale Polarisierung ist weniger schlimm. 
Moderaten Meinungen, Menschen die sich nicht für Politik interessieren, Dinge die gut laufen etc. sind nicht sichtbar. 
:::
...
Meinungen ändern sich nicht, aber gefühlte Spaltung nimmt ab, wenn keine Social Media
Auch positive Effekte: Nachrichtenwissen steigt durch social media nutzung
...
- Vertrauenswürdige Quellen boosten 
- [User Präferenzen berücksichtigen](https://doi.org/10.1177/1745691623119039) - Nachfrage & Tipps vor dem Posten
:::
...
:::: columns
::: column
![](https://pixabay.com/get/gffe330f37ef13bdfe3ff4faecea2cb5dc9c6730b36be78a0b2e10a24896f62a735ec0d934ac2925a2dbfa7ff1165c485.svg)
:::
::: column
### Social Media
...
![](images/in_a_nutshell.png){.absolute bottom="50" left="220" width="260"}
:::

::: {.column width="45%"}
[ORF Dok 1](https://on.orf.at/video/14228328/dok-1-oesterreich-rastet-aus-jeder-gegen-jeden)
![](images/dok1_orf.png){.absolute bottom=330 left="570" width="370"}
